...
while i < number_bits_encoded
    ...
    for y = 1 : 8
        ...
        if b == q_bits
            % get decoding value
            extracted_data( counter_extracted_data ) = double( ...
                get_bit_decoding( bits_read, q_bits ));
